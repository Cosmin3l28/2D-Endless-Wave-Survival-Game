...
class Game:
    def __init__(self):
        ...
        self.screen = pygame.display.set_mode(
            (389, 209), pygame.SCALED | pygame.HWSURFACE
        )
        self.framerate = 60
        ...
        self.assets = {
            ...
            "player/ninja/idle/idle": utils.Animation(
                utils.load_images_from_folder(
                    "assets/images/entities/player/ninja/idle/idle"
                ),
                10,
            ),
            "player/ninja/idle/idle_up": utils.Animation(
                utils.load_images_from_folder(
                    "assets/images/entities/player/ninja/idle/idle_up"
                ),
                10,
            ),
            "player/ninja/idle/idle_down": utils.Animation(
                utils.load_images_from_folder(
                    "assets/images/entities/player/ninja/idle/idle_down"
                ),
                10,
            ),
            "player/ninja/walk/walk": utils.Animation(
                utils.load_images_from_folder(
                    "assets/images/entities/player/ninja/walk/walk"
                ),
                10,
            ),
            "player/ninja/walk/walk_up": utils.Animation(
                utils.load_images_from_folder(
                    "assets/images/entities/player/ninja/walk/walk_up"
                ),
                10,
            ),
            "player/ninja/walk/walk_down": utils.Animation(
                utils.load_images_from_folder(
                    "assets/images/entities/player/ninja/walk/walk_down"
                ),
                10,
            ),
            "player/ninja/run/run": utils.Animation(
                utils.load_images_from_folder(
                    "assets/images/entities/player/ninja/run/run"
                ),
                10,
            ),
            "player/ninja/run/run_up": utils.Animation(
                utils.load_images_from_folder(
                    "assets/images/entities/player/ninja/run/run_up"
                ),
                10,
            ),
            "player/ninja/run/run_down": utils.Animation(
                utils.load_images_from_folder(
                    "assets/images/entities/player/ninja/run/run_down"
                ),
                10,
            ),
        }
        ...
        self.camera = utils.Camera(
            self, self.screen.width, self.screen.height
    ...
    def run(self):
        ...
        while running:
            ...
            self.player.render(
                self.screen, self.camera.camera_scroll
            )  # render the player on the screen
            self.player.update(
                self.movement
            )  # update the player position based on the movement
